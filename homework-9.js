...
const emailsWithMap = socialMediaComments.map(function(comment) {return comment.email;});
console.log('TASK 11 (Emails via map):', emailsWithMap)
const emailsStringJoin = emailsWithReduce.join(', ');console.log('TASK 12 (via join):', emailsStringJoin);
const emailsStringToString = emailsWithReduce.toString();console.log('TASK 12 (via toString):', emailsStringToString);